...
export default function DashboardLayout({
  ...
  return (
    <div
      className="flex min-h-screen pb-[68px] lg:pb-0 relative"
      dir="rtl"
    ...
    >
      ...
      {showLogoutConfirm && (
        ...
        >
          <div
            className="rounded-3xl p-6 max-w-sm w-full border border-white/10 shadow-2xl"
          ...
          {NAV_ITEMS.map(({ href, label, icon: Icon }) => {
            ...
            return (
              <Link
                ...
                style={
                  active
                    ? {
                        background:
                          "linear-gradient(135deg, rgba(255,107,0,0.9), rgba(255,107,0,0.7))",
              ...
              >
                ...
                {active && (
                  <ChevronLeft size={14} className="mr-auto relative z-10" />
                )}
              </Link>
            );
          })}
      ...
      <main className="flex-1 min-w-0 flex flex-col relative z-10">
        ...
        >
          <div className="flex items-center gap-3">
            {/* Desktop breadcrumb — text only, no logo */}
        ...
        <div className="flex items-center h-[68px] px-1">
          {NAV_ITEMS.slice(0, 5).map(({ href, label, icon: Icon }) => {
            ...
            return (
              ...
              >
                <div
                  className={`p-1.5 rounded-xl transition-all ${active ? "bg-orange-500/20" : ""}`}
                >
                  <Icon size={18} strokeWidth={active ? 2.5 : 2} />
                </div>
                <span
                  className={`text-[10px] font-bold leading-none ${active ? "text-orange-400" : ""}`}
                >
