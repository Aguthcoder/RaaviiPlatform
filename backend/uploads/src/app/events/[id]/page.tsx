    ...
    <div className="min-h-screen bg-white pb-28" dir="rtl">
      ...
      <div className="max-w-lg mx-auto px-4 pt-5">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          ...
          {/* مکان: آدرس کامل در عمومی نمایش می‌یابد */}
          <div className="bg-slate-50 rounded-2xl p-3 flex items-start gap-2.5">
            <MapPin size={18} className="text-orange-500 mt-0.5 flex-shrink-0" />
            <div>
              <p className="text-[10px] text-slate-400 font-medium">مکان</p>
              <p className="text-sm font-black text-slate-900 line-clamp-2">{event.location}</p>
            </div>
          </div>
        ...
        {event.host && (
          <div className="mb-8 bg-slate-50 rounded-2xl p-4 flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-slate-500">{event.host.events} رویداد برگزار شده</p>
            </div>
          </div>
        )}
      </div>
